...
- **Corpus today:** 151 events spanning 518 BCE → 1958 CE — the full launch arc.
  ...
  - `events_gupta.json` — 4 events, 320–460 CE (Chandragupta I, Samudragupta, Chandragupta II, Skandagupta)
  - `events_early-medieval.json` — 12 events, 606–1193 CE (Harsha, Pulakeshin, Xuanzang, Pala, Mahabalipuram, Adi Shankara, Tripartite, Cholas, Mahmud, Tarain I, Bakhtiyar Khilji)
  ...
  - `events_1857.json` — 2 events (Indian Rebellion 1857 overview + Lakshmibai's letters)
  - `events_princely_states.json` — 2 events (Sultan Jahan Begum + Telangana Rebellion)
  - `events_independence.json` — 24 events, 1885–1958 (+ Round Tables, Bhagat Singh execution 1931, Poona Pact 1932, INA Imphal–Kohima 1944, Lajpat Rai, Champaran, Gandhi Experiments, Sarojini, Ambedkar, Bose, Azad)
...
- **Corpus today:** 39 places across the subcontinent (ancient/north/south/east/northeast). Heaviest gathers: Delhi (19+ events including 1857 rebellion), Agra (7), Lahore (~6 with Bhagat Singh execution), Calcutta (5), Pataliputra (3 — Maurya/Gupta/Pala capital), Fatehpur Sikri (3), Bombay (3), Imphal (3 with INA Imphal–Kohima), Hampi (2), Tanjore (2). Plus polity-capital + ancient-sacred-site records (Sarnath, Bodh Gaya, Sanchi, Ujjain, Nalanda, Kanauj, Somnath, Bijapur, Golconda, Mysore, Charaideo, Yuksom, Gangtok, Agartala, Bhopal, Anandpur Sahib, Raigad, Thiruvananthapuram, Daulatabad, Gulbarga, Bidar, Madras).
...
- **Corpus today:** 27 polities spanning Maurya through Republic. Maurya (322–185 BCE), Gupta (320–550 CE), Harsha's Empire (606–647), Pala (750–1161), Imperial Cholas (985–1279), Delhi Sultanate, Bahmani, Vijayanagara, Madurai Sultanate, Bijapur, Golconda, Sur, Mughal, Maratha Confederacy, Khalsa/Sikh, Ahom Kingdom, Mysore Sultanate, Mysore Kingdom, Manipur Kingdom, Sikkim Kingdom, Tripura Kingdom, EIC, British Raj, Hyderabad State, Bhopal State, Travancore, Republic of India. All capital references resolve to place records — every cross-navigation link is clickable.
